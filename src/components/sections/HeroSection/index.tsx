    ...
    <section className="hero-background min-h-screen flex items-center justify-center pt-20">
      ...
      <div className="container mx-auto px-4">
        <div className="hero-content text-center space-y-8 max-w-4xl mx-auto">
          ...
          >
            Transform your business with cutting-edge digital solutions tailored for Africa&apos;s unique market
          </motion.p>
            ...
            <Link href="#how-it-works">
              <motion.button 
                className="px-8 py-4 rounded-lg border border-white/10 text-white
                  hover:border-gold-primary/50 hover:bg-gold-primary/5 transition-all duration-300"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                How It Works
